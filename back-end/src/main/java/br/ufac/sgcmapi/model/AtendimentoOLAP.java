...
public class AtendimentoOLAP implements Serializable{
  ...
  private String pacienteTemAusencias;
  ...
  public String getPacienteTemAusencias() {
    return pacienteTemAusencias;
  }
  public void setPacienteTemAusencias(String pacienteTemAusencias) {
    this.pacienteTemAusencias = pacienteTemAusencias;
  }
