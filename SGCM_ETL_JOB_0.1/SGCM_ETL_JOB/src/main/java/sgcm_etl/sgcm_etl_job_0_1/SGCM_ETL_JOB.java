...
package sgcm_etl.sgcm_etl_job_0_1;
...
/**
 * Job: SGCM_ETL_JOB Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SGCM_ETL_JOB implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SGCM_ETL_JOB";
	private final String projectName = "SGCM_ETL";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SGCM_ETL_JOB.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_ausencias_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_agendamentos_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
    static byte[] commonByteArray_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String profissional_especialidade;

				public String getProfissional_especialidade () {
					return this.profissional_especialidade;
				}
			    ...
			    public int paciente_ausencias;

				public int getPaciente_ausencias () {
					return this.paciente_ausencias;
				}
				
			    public int paciente_agendamentos;

				public int getPaciente_agendamentos () {
					return this.paciente_agendamentos;
				}
				
			    public boolean paciente_novo;

				public boolean getPaciente_novo () {
					return this.paciente_novo;
				}
				
			    public boolean paciente_tem_ausencias;

				public boolean getPaciente_tem_ausencias () {
					return this.paciente_tem_ausencias;
				}
	...
	public void copyDataTo(row1Struct other) {
		...
		other.atendimento_id = this.atendimento_id;
	            ...
	            other.profissional_especialidade = this.profissional_especialidade;
	            ...
	            other.paciente_ausencias = this.paciente_ausencias;
	            other.paciente_agendamentos = this.paciente_agendamentos;
	            other.paciente_novo = this.paciente_novo;
	            other.paciente_tem_ausencias = this.paciente_tem_ausencias;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SGCM_ETL_SGCM_ETL_JOB.length) {
				if(length < 1024 && commonByteArray_SGCM_ETL_SGCM_ETL_JOB.length == 0) {
   					commonByteArray_SGCM_ETL_SGCM_ETL_JOB = new byte[1024];
				} else {
   					commonByteArray_SGCM_ETL_SGCM_ETL_JOB = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SGCM_ETL_SGCM_ETL_JOB, 0, length);
			strReturn = new String(commonByteArray_SGCM_ETL_SGCM_ETL_JOB, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SGCM_ETL_SGCM_ETL_JOB, 0, length);
			strReturn = new String(commonByteArray_SGCM_ETL_SGCM_ETL_JOB, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SGCM_ETL_SGCM_ETL_JOB) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.profissional_especialidade = readString(dis);
			        ...
			        this.paciente_idade = dis.readInt();
					
					this.paciente_faixa_etaria = readString(dis);
					
			        this.paciente_ausencias = dis.readInt();
					
			        this.paciente_agendamentos = dis.readInt();
					
			        this.paciente_novo = dis.readBoolean();
					
			        this.paciente_tem_ausencias = dis.readBoolean();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.profissional_especialidade,dos);
					...
					// int
		            	...
		            	dos.writeInt(this.paciente_idade);
					...
					// int
		            	...
		            	dos.writeInt(this.paciente_ausencias);
					
					// int
				
		            	dos.writeInt(this.paciente_agendamentos);
					
					// boolean
				
		            	dos.writeBoolean(this.paciente_novo);
					
					// boolean
				
		            	dos.writeBoolean(this.paciente_tem_ausencias);
    ...
    public String toString() {
		...
		sb.append(",profissional_especialidade="+profissional_especialidade);
		...
		sb.append(",paciente_ausencias="+String.valueOf(paciente_ausencias));
		sb.append(",paciente_agendamentos="+String.valueOf(paciente_agendamentos));
		sb.append(",paciente_novo="+String.valueOf(paciente_novo));
		sb.append(",paciente_tem_ausencias="+String.valueOf(paciente_tem_ausencias));
...
public static class joinStruct implements routines.system.IPersistableRow<joinStruct> {
    final static byte[] commonByteArrayLock_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
    static byte[] commonByteArray_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final joinStruct other = (joinStruct) obj;
	...
	public void copyDataTo(joinStruct other) {
	...
	public void copyKeysDataTo(joinStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(joinStruct other) {
...
joinStruct join = new joinStruct();
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/AluizioCatao/Documents/Code/topicos-emergentes/atendimento_olap.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[2]="atendimento_dia_da_semana";
                                    headColutFileOutputDelimited_1[3]="atendimento_semana_no_mes";
                                    headColutFileOutputDelimited_1[4]="atendimento_mes";
                                    headColutFileOutputDelimited_1[5]="atendimento_hora";
                                    headColutFileOutputDelimited_1[6]="atendimento_status";
                                    headColutFileOutputDelimited_1[7]="profissional_nome";
                                    headColutFileOutputDelimited_1[8]="profissional_especialidade";
                                    ...
                                    headColutFileOutputDelimited_1[15]="paciente_idade";
                                    headColutFileOutputDelimited_1[16]="paciente_faixa_etaria";
                                    headColutFileOutputDelimited_1[17]="paciente_ausencias";
                                    headColutFileOutputDelimited_1[18]="paciente_agendamentos";
                                    headColutFileOutputDelimited_1[19]="paciente_novo";
                                    headColutFileOutputDelimited_1[20]="paciente_tem_ausencias";
                                    headColutFileOutputDelimited_1[21]="paciente_ausente";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tq+jy1ROmE2wme27dPCIH77n3NKO5/6fD8jLKA==");
...
int count_tDBOutput_1=0;
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`atendimento_id` BIGINT(19)   not null ,`atendimento_data` DATE  not null ,`atendimento_dia_da_semana` INT(1)   not null ,`atendimento_semana_no_mes` INT(1)   not null ,`atendimento_mes` INT(2)   not null ,`atendimento_hora` TIME  not null ,`atendimento_status` VARCHAR(255)   not null ,`profissional_nome` VARCHAR(255)   not null ,`profissional_especialidade` VARCHAR(255)   not null ,`unidade_nome` VARCHAR(255)   not null ,`convenio_nome` VARCHAR(255)   not null ,`paciente_nome` VARCHAR(255)   not null ,`paciente_sexo` VARCHAR(255)   not null ,`paciente_grupo_sanguineo` VARCHAR(255)   not null ,`paciente_data_nascimento` DATE  not null ,`paciente_idade` INT(3)   not null ,`paciente_faixa_etaria` VARCHAR(255)   not null ,`paciente_ausencias` INT(100)   not null ,`paciente_agendamentos` INT(100)   not null ,`paciente_novo` BIT(0)   not null ,`paciente_tem_ausencias` BIT(0)   not null ,`paciente_ausente` BIT(0)   not null ,primary key(`atendimento_id`))");
                                }

		        String insert_tDBOutput_1 = "INSERT INTO `" + "atendimento_olap" + "` (`atendimento_id`,`atendimento_data`,`atendimento_dia_da_semana`,`atendimento_semana_no_mes`,`atendimento_mes`,`atendimento_hora`,`atendimento_status`,`profissional_nome`,`profissional_especialidade`,`unidade_nome`,`convenio_nome`,`paciente_nome`,`paciente_sexo`,`paciente_grupo_sanguineo`,`paciente_data_nascimento`,`paciente_idade`,`paciente_faixa_etaria`,`paciente_ausencias`,`paciente_agendamentos`,`paciente_novo`,`paciente_tem_ausencias`,`paciente_ausente`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tReplicate_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"join");
					}
...
unidadeStruct unidadeDefault = new unidadeStruct();
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ausenciasStruct> tHash_Lookup_ausencias = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ausenciasStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ausenciasStruct>) 
					globalMap.get( "tHash_Lookup_ausencias" ))
					;					
					
	

ausenciasStruct ausenciasHashKey = new ausenciasStruct();
ausenciasStruct ausenciasDefault = new ausenciasStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<agendamentosStruct> tHash_Lookup_agendamentos = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<agendamentosStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<agendamentosStruct>) 
					globalMap.get( "tHash_Lookup_agendamentos" ))
					;					
					
	

agendamentosStruct agendamentosHashKey = new agendamentosStruct();
agendamentosStruct agendamentosDefault = new agendamentosStruct();
// ###############################        
...
class  Var__tMap_1__Struct  {
	...
	boolean paciente_ausente;
	int atendimento_dia_da_semana;
	int atendimento_semana_no_mes;
	int atendimento_mes;
	String paciente_grupo_sanguineo;
	int paciente_idade;
	String paciente_faixa_etaria;
	boolean paciente_novo;
	boolean paciente_tem_ausencias;
}
...
joinStruct join_tmp = new joinStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:HEFqjtKKR7dWeJJPObWlGpVIGdRVRPT3ySxX3A==");
	...
	currentComponent="tMap_1";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "ausencias" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopausencias = false;
       		  	    	
       		  	    	
 							ausenciasStruct ausenciasObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_ausencias__id = atendimento.id;
	                        		    	if(exprKeyValue_ausencias__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			ausenciasHashKey.id = (long)(Long) exprKeyValue_ausencias__id;
                        		    		}
                        		    		

								
		                        	ausenciasHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_ausencias.lookup( ausenciasHashKey );
				           		...
				           		if(tHash_Lookup_ausencias != null && tHash_Lookup_ausencias.getCount(ausenciasHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'ausencias' and it contains more one result from keys :  ausencias.id = '" + ausenciasHashKey.id + "'");
								} // G 071
							

							ausenciasStruct ausencias = null;
                    		  	 
							   
                    		  	 
	       		  	    	ausenciasStruct fromLookup_ausencias = null;
							ausencias = ausenciasDefault;
										 
							
								 
							
							
								if (tHash_Lookup_ausencias !=null && tHash_Lookup_ausencias.hasNext()) { // G 099
								
							
								
								fromLookup_ausencias = tHash_Lookup_ausencias.next();
							...
							if(fromLookup_ausencias != null) {
								ausencias = fromLookup_ausencias;
							}
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "agendamentos" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopagendamentos = false;
       		  	    	
       		  	    	
 							agendamentosStruct agendamentosObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_agendamentos__id = atendimento.id;
	                        		    	if(exprKeyValue_agendamentos__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			agendamentosHashKey.id = (long)(Long) exprKeyValue_agendamentos__id;
                        		    		}
                        		    		

								
		                        	agendamentosHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_agendamentos.lookup( agendamentosHashKey );
				           		...
				           		if(tHash_Lookup_agendamentos != null && tHash_Lookup_agendamentos.getCount(agendamentosHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'agendamentos' and it contains more one result from keys :  agendamentos.id = '" + agendamentosHashKey.id + "'");
								} // G 071
							

							agendamentosStruct agendamentos = null;
                    		  	 
							   
                    		  	 
	       		  	    	agendamentosStruct fromLookup_agendamentos = null;
							agendamentos = agendamentosDefault;
										 
							
								 
							
							
								if (tHash_Lookup_agendamentos !=null && tHash_Lookup_agendamentos.hasNext()) { // G 099
								
							
								
								fromLookup_agendamentos = tHash_Lookup_agendamentos.next();
							...
							if(fromLookup_agendamentos != null) {
								agendamentos = fromLookup_agendamentos;
							}
...
Var.paciente_ausente = TalendDate.compareDate(atendimento.data,TalendDate.getCurrentDate(),"yyyy-MM-dd") == -1 && (atendimento.status.equals("AGENDADO") || atendimento.status.equals("CONFIRMADO") || atendimento.status.equals("CANCELADO")) ;
Var.atendimento_dia_da_semana = TalendDate.getPartOfDate("DAY_OF_WEEK", atendimento.data) ;
Var.atendimento_semana_no_mes = TalendDate.getPartOfDate("WEEK_OF_MONTH", atendimento.data) ;
Var.atendimento_mes = TalendDate.getPartOfDate("MONTH",atendimento.data) ;
Var.paciente_grupo_sanguineo = paciente.grupo_sanguineo == null ? "Não informado" : paciente.grupo_sanguineo ;
Var.paciente_idade = TalendDate.diffDateFloor(TalendDate.getCurrentDate(),paciente.data_nascimento,"yyyy") ;
Var.paciente_faixa_etaria = Var.paciente_idade >= 0 && Var.paciente_idade <= 17 ? "Jovem" : ( Var.paciente_idade >= 18 && Var.paciente_idade <= 59 ? "Adulto" : "Idoso" ) ;
Var.paciente_novo = agendamentos.agendamentos == 0 ;
Var.paciente_tem_ausencias = ausencias.ausencias > 0 ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'join'
join_tmp.atendimento_id = atendimento.id ;
join_tmp.atendimento_data = atendimento.data ;
join_tmp.atendimento_dia_da_semana = Var.atendimento_dia_da_semana ;
join_tmp.atendimento_semana_no_mes = Var.atendimento_semana_no_mes ;
join_tmp.atendimento_mes = Var.atendimento_mes ;
join_tmp.atendimento_hora = atendimento.hora ;
join_tmp.atendimento_status = atendimento.status ;
join_tmp.profissional_nome = profissional.nome ;
join_tmp.profissional_especialidade = especialidade.nome ;
join_tmp.unidade_nome = unidade.nome ;
join_tmp.convenio_nome = Var.convenio_nome ;
join_tmp.paciente_nome = paciente.nome ;
join_tmp.paciente_sexo = paciente.sexo ;
join_tmp.paciente_grupo_sanguineo = Var.paciente_grupo_sanguineo ;
join_tmp.paciente_data_nascimento = paciente.data_nascimento ;
join_tmp.paciente_idade = Var.paciente_idade ;
join_tmp.paciente_faixa_etaria = Var.paciente_faixa_etaria ;
join_tmp.paciente_ausencias = ausencias.ausencias ;
join_tmp.paciente_agendamentos = agendamentos.agendamentos ;
join_tmp.paciente_novo = Var.paciente_novo ;
join_tmp.paciente_tem_ausencias = Var.paciente_tem_ausencias ;
join_tmp.paciente_ausente = Var.paciente_ausente ;
join = join_tmp;
// ###############################
...
if(join != null) { 
	...
	row1.atendimento_id = join.atendimento_id;								
	row1.atendimento_data = join.atendimento_data;								
	row1.atendimento_dia_da_semana = join.atendimento_dia_da_semana;								
	row1.atendimento_semana_no_mes = join.atendimento_semana_no_mes;								
	row1.atendimento_mes = join.atendimento_mes;								
	row1.atendimento_hora = join.atendimento_hora;								
	row1.atendimento_status = join.atendimento_status;								
	row1.profissional_nome = join.profissional_nome;								
	row1.profissional_especialidade = join.profissional_especialidade;								
	row1.unidade_nome = join.unidade_nome;								
	row1.convenio_nome = join.convenio_nome;								
	row1.paciente_nome = join.paciente_nome;								
	row1.paciente_sexo = join.paciente_sexo;								
	row1.paciente_grupo_sanguineo = join.paciente_grupo_sanguineo;								
	row1.paciente_data_nascimento = join.paciente_data_nascimento;								
	row1.paciente_idade = join.paciente_idade;								
	row1.paciente_faixa_etaria = join.paciente_faixa_etaria;								
	row1.paciente_ausencias = join.paciente_ausencias;								
	row1.paciente_agendamentos = join.paciente_agendamentos;								
	row1.paciente_novo = join.paciente_novo;								
	row1.paciente_tem_ausencias = join.paciente_tem_ausencias;								
	row1.paciente_ausente = join.paciente_ausente;			
	row2 = new row2Struct();
						
	row2.atendimento_id = join.atendimento_id;								
	row2.atendimento_data = join.atendimento_data;								
	row2.atendimento_dia_da_semana = join.atendimento_dia_da_semana;								
	row2.atendimento_semana_no_mes = join.atendimento_semana_no_mes;								
	row2.atendimento_mes = join.atendimento_mes;								
	row2.atendimento_hora = join.atendimento_hora;								
	row2.atendimento_status = join.atendimento_status;								
	row2.profissional_nome = join.profissional_nome;								
	row2.profissional_especialidade = join.profissional_especialidade;								
	row2.unidade_nome = join.unidade_nome;								
	row2.convenio_nome = join.convenio_nome;								
	row2.paciente_nome = join.paciente_nome;								
	row2.paciente_sexo = join.paciente_sexo;								
	row2.paciente_grupo_sanguineo = join.paciente_grupo_sanguineo;								
	row2.paciente_data_nascimento = join.paciente_data_nascimento;								
	row2.paciente_idade = join.paciente_idade;								
	row2.paciente_faixa_etaria = join.paciente_faixa_etaria;								
	row2.paciente_ausencias = join.paciente_ausencias;								
	row2.paciente_agendamentos = join.paciente_agendamentos;								
	row2.paciente_novo = join.paciente_novo;								
	row2.paciente_tem_ausencias = join.paciente_tem_ausencias;								
	row2.paciente_ausente = join.paciente_ausente;			
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[22];
                            rowtFileOutputDelimited_1[0]=String.valueOf(row1.atendimento_id);
                            rowtFileOutputDelimited_1[1]=row1.atendimento_data == null ? null : FormatterUtils.format_Date(row1.atendimento_data, "yyyy-MM-dd");
                            rowtFileOutputDelimited_1[2]=String.valueOf(row1.atendimento_dia_da_semana);
                            rowtFileOutputDelimited_1[3]=String.valueOf(row1.atendimento_semana_no_mes);
                            rowtFileOutputDelimited_1[4]=String.valueOf(row1.atendimento_mes);
                            rowtFileOutputDelimited_1[5]=row1.atendimento_hora == null ? null : row1.atendimento_hora;
                            rowtFileOutputDelimited_1[6]=row1.atendimento_status == null ? null : row1.atendimento_status;
                            rowtFileOutputDelimited_1[7]=row1.profissional_nome == null ? null : row1.profissional_nome;
                            rowtFileOutputDelimited_1[8]=row1.profissional_especialidade == null ? null : row1.profissional_especialidade;
                            rowtFileOutputDelimited_1[9]=row1.unidade_nome == null ? null : row1.unidade_nome;
                            rowtFileOutputDelimited_1[10]=row1.convenio_nome == null ? null : row1.convenio_nome;
                            rowtFileOutputDelimited_1[11]=row1.paciente_nome == null ? null : row1.paciente_nome;
                            rowtFileOutputDelimited_1[12]=row1.paciente_sexo == null ? null : row1.paciente_sexo;
                            rowtFileOutputDelimited_1[13]=row1.paciente_grupo_sanguineo == null ? null : row1.paciente_grupo_sanguineo;
                            rowtFileOutputDelimited_1[14]=row1.paciente_data_nascimento == null ? null : FormatterUtils.format_Date(row1.paciente_data_nascimento, "yyyy-MM-dd");
                            rowtFileOutputDelimited_1[15]=String.valueOf(row1.paciente_idade);
                            rowtFileOutputDelimited_1[16]=row1.paciente_faixa_etaria == null ? null : row1.paciente_faixa_etaria;
                            rowtFileOutputDelimited_1[17]=String.valueOf(row1.paciente_ausencias);
                            rowtFileOutputDelimited_1[18]=String.valueOf(row1.paciente_agendamentos);
                            rowtFileOutputDelimited_1[19]=String.valueOf(row1.paciente_novo);
                            rowtFileOutputDelimited_1[20]=String.valueOf(row1.paciente_tem_ausencias);
                            rowtFileOutputDelimited_1[21]=String.valueOf(row1.paciente_ausente);
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                        pstmt_tDBOutput_1.setLong(1, row2.atendimento_id);

                        if(row2.atendimento_data != null) {
date_tDBOutput_1 = row2.atendimento_data.getTime();
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.DATE);
                        ...
                        pstmt_tDBOutput_1.setInt(3, row2.atendimento_dia_da_semana);

                        pstmt_tDBOutput_1.setInt(4, row2.atendimento_semana_no_mes);

                        pstmt_tDBOutput_1.setInt(5, row2.atendimento_mes);

                        if(row2.atendimento_hora == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, row2.atendimento_hora);
}

                        if(row2.atendimento_status == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, row2.atendimento_status);
}

                        if(row2.profissional_nome == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, row2.profissional_nome);
}

                        if(row2.profissional_especialidade == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, row2.profissional_especialidade);
}

                        if(row2.unidade_nome == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, row2.unidade_nome);
}

                        if(row2.convenio_nome == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, row2.convenio_nome);
}

                        if(row2.paciente_nome == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, row2.paciente_nome);
}

                        if(row2.paciente_sexo == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, row2.paciente_sexo);
}

                        if(row2.paciente_grupo_sanguineo == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, row2.paciente_grupo_sanguineo);
}

                        if(row2.paciente_data_nascimento != null) {
date_tDBOutput_1 = row2.paciente_data_nascimento.getTime();
if(date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
...
pstmt_tDBOutput_1.setNull(15, java.sql.Types.DATE);
                        ...
                        pstmt_tDBOutput_1.setInt(16, row2.paciente_idade);

                        if(row2.paciente_faixa_etaria == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, row2.paciente_faixa_etaria);
}

                        pstmt_tDBOutput_1.setInt(18, row2.paciente_ausencias);

                        pstmt_tDBOutput_1.setInt(19, row2.paciente_agendamentos);

                        pstmt_tDBOutput_1.setBoolean(20, row2.paciente_novo);

                        pstmt_tDBOutput_1.setBoolean(21, row2.paciente_tem_ausencias);

                        pstmt_tDBOutput_1.setBoolean(22, row2.paciente_ausente);
...
// # Lookup hashes releasing
					...
					if(tHash_Lookup_ausencias != null) {
						tHash_Lookup_ausencias.endGet();
					}
					globalMap.remove( "tHash_Lookup_ausencias" );

					
					
				
					if(tHash_Lookup_agendamentos != null) {
						tHash_Lookup_agendamentos.endGet();
					}
					globalMap.remove( "tHash_Lookup_agendamentos" );
 ...
 */
	...
	currentComponent="tReplicate_1";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"join");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_paciente";
		...
		int tos_count_tAdvancedHash_paciente = 0;
			   		...
			   		// source node:tDBInput_10 - inputs:(after_tDBInput_1) outputs:(paciente,paciente) | target node:tAdvancedHash_paciente - inputs:(paciente) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
 ...
 */
	...
	final String decryptedPassword_tDBInput_10 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ara9H0sR5xtaqxxIhrJHBl+IuVQHBPjj3a3iyw==");
				
				String dbPwd_tDBInput_10 = decryptedPassword_tDBInput_10;
				
        String properties_tDBInput_10 = "noDatetimeStringSync=true&enabledTLSProtocols=TLSv1.2,TLSv1.1,TLSv1";
        if (properties_tDBInput_10 == null || properties_tDBInput_10.trim().length() == 0) {
            properties_tDBInput_10 = "";
        }
        String url_tDBInput_10 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "sgcm" + "?" + properties_tDBInput_10;
...
+"ciente`.`sexo`, \n  `paciente`.`telefone`\nFROM `paciente`";
            ...
            paciente.id = rs_tDBInput_10.getLong(1);
        	...
        	paciente.cep = routines.system.JDBCUtil.getString(rs_tDBInput_10, 2, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 3) {
								paciente.cidade = null;
							} else {
	                         		
        	paciente.cidade = routines.system.JDBCUtil.getString(rs_tDBInput_10, 3, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 4) {
								paciente.data_nascimento = null;
							} else {
										
				if(rs_tDBInput_10.getString(4) != null) {
					String dateString_tDBInput_10 = rs_tDBInput_10.getString(4);
					if (!("0000-00-00").equals(dateString_tDBInput_10) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_10)) {
						paciente.data_nascimento = rs_tDBInput_10.getTimestamp(4);
					} else {
						paciente.data_nascimento = (java.util.Date) year0_tDBInput_10.clone();
					}
				} else {
					paciente.data_nascimento =  null;
				}
        	...
        	paciente.email = routines.system.JDBCUtil.getString(rs_tDBInput_10, 5, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 6) {
								paciente.endereco = null;
							} else {
	                         		
        	paciente.endereco = routines.system.JDBCUtil.getString(rs_tDBInput_10, 6, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 7) {
								paciente.estado = null;
							} else {
	                         		
        	paciente.estado = routines.system.JDBCUtil.getString(rs_tDBInput_10, 7, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 8) {
								paciente.grupo_sanguineo = null;
							} else {
	                         		
        	paciente.grupo_sanguineo = routines.system.JDBCUtil.getString(rs_tDBInput_10, 8, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 9) {
								paciente.nome = null;
							} else {
	                         		
        	paciente.nome = routines.system.JDBCUtil.getString(rs_tDBInput_10, 9, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 10) {
								paciente.sexo = null;
							} else {
	                         		
        	paciente.sexo = routines.system.JDBCUtil.getString(rs_tDBInput_10, 10, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 11) {
								paciente.telefone = null;
							} else {
	                         		
        	paciente.telefone = routines.system.JDBCUtil.getString(rs_tDBInput_10, 11, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_profissional";
		...
		int tos_count_tAdvancedHash_profissional = 0;
			   		...
			   		// source node:tDBInput_15 - inputs:(after_tDBInput_1) outputs:(profissional,profissional) | target node:tAdvancedHash_profissional - inputs:(profissional) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
 ...
 */
	...
	final String decryptedPassword_tDBInput_15 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+v0J7AojNYTL4BYy6OQBEmXBWccbE2PSsG6xlw==");
        ...
        String url_tDBInput_15 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "sgcm" + "?" + properties_tDBInput_15;
...
+"l`";
            ...
            profissional.id = rs_tDBInput_15.getLong(1);
        	...
        	profissional.email = routines.system.JDBCUtil.getString(rs_tDBInput_15, 2, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 3) {
								profissional.nome = null;
							} else {
	                         		
        	profissional.nome = routines.system.JDBCUtil.getString(rs_tDBInput_15, 3, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 4) {
								profissional.registro_conselho = null;
							} else {
	                         		
        	profissional.registro_conselho = routines.system.JDBCUtil.getString(rs_tDBInput_15, 4, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 5) {
								profissional.telefone = null;
							} else {
	                         		
        	profissional.telefone = routines.system.JDBCUtil.getString(rs_tDBInput_15, 5, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 6) {
								profissional.especialidade_id = 0;
							} else {
		                          
            profissional.especialidade_id = rs_tDBInput_15.getLong(6);
            if(rs_tDBInput_15.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            profissional.unidade_id = rs_tDBInput_15.getLong(7);
            if(rs_tDBInput_15.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_convenio";
		...
		int tos_count_tAdvancedHash_convenio = 0;
			   		...
			   		// source node:tDBInput_3 - inputs:(after_tDBInput_1) outputs:(convenio,convenio) | target node:tAdvancedHash_convenio - inputs:(convenio) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aACQAx5hCOdJ6HGBez8lcfYnO26HUzDFxybg9Q==");
...
+" `convenio`.`razao_social`, \n  `convenio`.`representante`, \n  `convenio`.`telefone`\nFROM `convenio`";
            ...
            convenio.id = rs_tDBInput_3.getLong(1);
            ...
            convenio.ativo = rs_tDBInput_3.getBoolean(2);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	convenio.cnpj = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								convenio.email = null;
							} else {
	                         		
        	convenio.email = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								convenio.nome = null;
							} else {
	                         		
        	convenio.nome = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								convenio.razao_social = null;
							} else {
	                         		
        	convenio.razao_social = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								convenio.representante = null;
							} else {
	                         		
        	convenio.representante = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 8) {
								convenio.telefone = null;
							} else {
	                         		
        	convenio.telefone = routines.system.JDBCUtil.getString(rs_tDBInput_3, 8, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_especialidade";
		...
		int tos_count_tAdvancedHash_especialidade = 0;
			   		...
			   		// source node:tDBInput_6 - inputs:(after_tDBInput_1) outputs:(especialidade,especialidade) | target node:tAdvancedHash_especialidade - inputs:(especialidade) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:MDO8xKLEtOitOD62t9hcB4xlVrSbUIAkD9/22A==");
        ...
        String url_tDBInput_6 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "sgcm" + "?" + properties_tDBInput_6;
            ...
            especialidade.id = rs_tDBInput_6.getLong(1);
        	...
        	especialidade.nome = routines.system.JDBCUtil.getString(rs_tDBInput_6, 2, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_unidade";
		...
		int tos_count_tAdvancedHash_unidade = 0;
			   		...
			   		// source node:tDBInput_21 - inputs:(after_tDBInput_1) outputs:(unidade,unidade) | target node:tAdvancedHash_unidade - inputs:(unidade) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
	...
	currentComponent="tDBInput_21";
		...
		int tos_count_tDBInput_21 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_21 = null;
				String driverClass_tDBInput_21 = "com.mysql.cj.jdbc.Driver";
			    java.lang.Class jdbcclazz_tDBInput_21 = java.lang.Class.forName(driverClass_tDBInput_21);
				String dbUser_tDBInput_21 = "root";
				
				 
	final String decryptedPassword_tDBInput_21 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:anb63FkhEqv6UgPwn0fFum6f19+5DVE9fTipoQ==");
				
				String dbPwd_tDBInput_21 = decryptedPassword_tDBInput_21;
				
        String properties_tDBInput_21 = "noDatetimeStringSync=true&enabledTLSProtocols=TLSv1.2,TLSv1.1,TLSv1";
        if (properties_tDBInput_21 == null || properties_tDBInput_21.trim().length() == 0) {
            properties_tDBInput_21 = "";
        }
        String url_tDBInput_21 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "sgcm" + "?" + properties_tDBInput_21;
            ...
            unidade.id = rs_tDBInput_21.getLong(1);
        	...
        	unidade.endereco = routines.system.JDBCUtil.getString(rs_tDBInput_21, 2, false);
		                    }
							if(colQtyInRs_tDBInput_21 < 3) {
								unidade.nome = null;
							} else {
	                         		
        	unidade.nome = routines.system.JDBCUtil.getString(rs_tDBInput_21, 3, false);
		                    }
...
public static class ausenciasStruct implements routines.system.IPersistableComparableLookupRow<ausenciasStruct> {
    final static byte[] commonByteArrayLock_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
    static byte[] commonByteArray_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ausenciasStruct other = (ausenciasStruct) obj;
	...
	public void copyDataTo(ausenciasStruct other) {

		other.id = this.id;
	            other.ausencias = this.ausencias;
	            
	}

	public void copyKeysDataTo(ausenciasStruct other) {
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.ausencias = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.ausencias);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("id="+String.valueOf(id));
		sb.append(",ausencias="+String.valueOf(ausencias));
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(ausenciasStruct other) {
...
public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		ausenciasStruct ausencias = new ausenciasStruct();
	...
	/**
	 * [tAdvancedHash_ausencias begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_ausencias", false);
		start_Hash.put("tAdvancedHash_ausencias", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_ausencias";

	
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ausencias");
					}
				
		int tos_count_tAdvancedHash_ausencias = 0;
		

			   		// connection name:ausencias
			   		// source node:tDBInput_2 - inputs:(after_tDBInput_1) outputs:(ausencias,ausencias) | target node:tAdvancedHash_ausencias - inputs:(ausencias) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_ausencias = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ausenciasStruct> tHash_Lookup_ausencias =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<ausenciasStruct>getLookup(matchingModeEnum_ausencias);
	   						   
		   	   	   globalMap.put("tHash_Lookup_ausencias", tHash_Lookup_ausencias);
...
/**
 * [tAdvancedHash_ausencias begin ] stop
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4o4BKVgstSk6SWN/GK2RghRBI3tGR0OHrqCNNg==");
        ...
        String url_tDBInput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "sgcm" + "?" + properties_tDBInput_2;
		    ...
		    String dbquery_tDBInput_2 = "SELECT a1.id , (\n	SELECT COUNT(DISTINCT a2.data, a2.hora)\n	FROM atendimento a2\n	WHERE a2.paciente_id=a1.paciente_id "
+"AND a2.data < a1.data \n	AND a2.status IN ('CANCELADO', 'AGENDADO', 'CONFIRMADO')\n) AS ausencias\nFROM atendimento a1";
            ...
            ausencias.id = rs_tDBInput_2.getLong(1);
            ...
            ausencias.ausencias = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	/**
	 * [tAdvancedHash_ausencias main ] start
	 */
	...
	currentComponent="tAdvancedHash_ausencias";
					...
					ausenciasStruct ausencias_HashRow = new ausenciasStruct();
		   	   	   
				
				ausencias_HashRow.id = ausencias.id;
				
				ausencias_HashRow.ausencias = ausencias.ausencias;
				
			tHash_Lookup_ausencias.put(ausencias_HashRow);
	...
	tos_count_tAdvancedHash_ausencias++;

/**
 * [tAdvancedHash_ausencias main ] stop
 */
	
	/**
	 * [tAdvancedHash_ausencias process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_ausencias process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_ausencias process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_ausencias process_data_end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_ausencias end ] start
	 */
...
tHash_Lookup_ausencias.endPut();

				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ausencias");
			  	}
			  	
 

ok_Hash.put("tAdvancedHash_ausencias", true);
end_Hash.put("tAdvancedHash_ausencias", System.currentTimeMillis());




/**
 * [tAdvancedHash_ausencias end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_ausencias finally ] start
	 */
...
/**
 * [tAdvancedHash_ausencias finally ] stop
 */
...
public static class agendamentosStruct implements routines.system.IPersistableComparableLookupRow<agendamentosStruct> {
    final static byte[] commonByteArrayLock_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
    static byte[] commonByteArray_SGCM_ETL_SGCM_ETL_JOB = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final agendamentosStruct other = (agendamentosStruct) obj;
	...
	public void copyDataTo(agendamentosStruct other) {

		other.id = this.id;
	            other.agendamentos = this.agendamentos;
	            
	}

	public void copyKeysDataTo(agendamentosStruct other) {
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.agendamentos = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.agendamentos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.agendamentos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("id="+String.valueOf(id));
		sb.append(",agendamentos="+String.valueOf(agendamentos));
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(agendamentosStruct other) {
...
public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		agendamentosStruct agendamentos = new agendamentosStruct();
	...
	/**
	 * [tAdvancedHash_agendamentos begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_agendamentos", false);
		start_Hash.put("tAdvancedHash_agendamentos", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_agendamentos";

	
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"agendamentos");
					}
				
		int tos_count_tAdvancedHash_agendamentos = 0;
		

			   		// connection name:agendamentos
			   		// source node:tDBInput_4 - inputs:(after_tDBInput_1) outputs:(agendamentos,agendamentos) | target node:tAdvancedHash_agendamentos - inputs:(agendamentos) outputs:()
			   		// linked node: tMap_1 - inputs:(atendimento,paciente,profissional,convenio,especialidade,unidade,ausencias,agendamentos) outputs:(join)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_agendamentos = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<agendamentosStruct> tHash_Lookup_agendamentos =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<agendamentosStruct>getLookup(matchingModeEnum_agendamentos);
	   						   
		   	   	   globalMap.put("tHash_Lookup_agendamentos", tHash_Lookup_agendamentos);
...
/**
 * [tAdvancedHash_agendamentos begin ] stop
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:l27+bubnAYCL/sH6KeP33lRRMq2eO7c1tvaNsA==");
        ...
        String url_tDBInput_4 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "sgcm" + "?" + properties_tDBInput_4;
		    ...
		    String dbquery_tDBInput_4 = "SELECT a1.id, (\n	SELECT COUNT(DISTINCT a2.data, a2.hora)\n	FROM atendimento a2\n	WHERE a2.paciente_id=a1.paciente_id "
+"\n	AND a2.data < a1.data\n) AS agendamentos\nFROM atendimento a1";
            ...
            agendamentos.id = rs_tDBInput_4.getLong(1);
            ...
            agendamentos.agendamentos = rs_tDBInput_4.getInt(2);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	/**
	 * [tAdvancedHash_agendamentos main ] start
	 */
	...
	currentComponent="tAdvancedHash_agendamentos";
					...
					agendamentosStruct agendamentos_HashRow = new agendamentosStruct();
		   	   	   
				
				agendamentos_HashRow.id = agendamentos.id;
				
				agendamentos_HashRow.agendamentos = agendamentos.agendamentos;
				
			tHash_Lookup_agendamentos.put(agendamentos_HashRow);
	...
	tos_count_tAdvancedHash_agendamentos++;

/**
 * [tAdvancedHash_agendamentos main ] stop
 */
	
	/**
	 * [tAdvancedHash_agendamentos process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_agendamentos process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_agendamentos process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_agendamentos process_data_end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_agendamentos end ] start
	 */
...
tHash_Lookup_agendamentos.endPut();

				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"agendamentos");
			  	}
			  	
 

ok_Hash.put("tAdvancedHash_agendamentos", true);
end_Hash.put("tAdvancedHash_agendamentos", System.currentTimeMillis());




/**
 * [tAdvancedHash_agendamentos end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_agendamentos finally ] start
	 */
...
/**
 * [tAdvancedHash_agendamentos finally ] stop
 */
    ...
    public static void main(String[] args){
        final SGCM_ETL_JOB SGCM_ETL_JOBClass = new SGCM_ETL_JOB();

        int exitCode = SGCM_ETL_JOBClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SGCM_ETL_JOB.class.getClassLoader().getResourceAsStream("sgcm_etl/sgcm_etl_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SGCM_ETL_JOB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SGCM_ETL_JOB");
        }
...
/************************************************************************************************
 *     307520 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 de julho de 2022 18:15:04 ACT
 ************************************************************************************************/